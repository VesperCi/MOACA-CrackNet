...
class UNet(nn.Module):
    def __init__(self, in_ch, out_ch):
        ...
        self.OCconv2 = OctaveConv(kernel_size=(3, 3), in_ch=64, out_ch=128, bias=False, stride=2, alpha=0.75).cuda()
        ...
        self.OCconv3 = OctaveConv(kernel_size=(3, 3), in_ch=128, out_ch=256, bias=False, stride=2, alpha=0.75).cuda()
        ...
        self.OCconv4 = OctaveConv(kernel_size=(3, 3), in_ch=256, out_ch=512, bias=False, stride=2, alpha=0.75).cuda()
        ...
        self.OCconv5 = OctaveConv(kernel_size=(3, 3), in_ch=512, out_ch=1024, bias=False, stride=2, alpha=0.75).cuda()
