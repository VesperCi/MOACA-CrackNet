...
class UNet(nn.Module):
    def __init__(self, in_ch, out_ch):
        ...
        self.OCconvf1 = FirstOctaveConv(kernel_size=(3, 3), in_ch=in_ch, out_ch=64, bias=False,alpha=0.125 ).cuda()
        self.OCconv1 = OctaveConv(kernel_size=(3, 3), in_ch=64, out_ch=64, bias=False,alpha=0.125).cuda()
        self.OCconvl1 = LastOctaveConv(kernel_size=(3, 3), in_ch=64, out_ch=64, bias=False, stride=2, alpha=0.125).cuda()
        #self.OCconvf2 = FirstOctaveConv(kernel_size=(3, 3), in_ch=64, out_ch=128, bias=False, stride=2, alpha=0.25 ).cuda()
        self.OCconv2 = OctaveConv(kernel_size=(3, 3), in_ch=64, out_ch=128, bias=False, alpha=0.125).cuda()
        self.OCconvl2 = LastOctaveConv(kernel_size=(3, 3), in_ch=128, out_ch=128, bias=False, stride=2, alpha=0.125).cuda()
        #self.OCconvf3= FirstOctaveConv(kernel_size=(3, 3), in_ch=128, out_ch=256, bias=False, stride=2, alpha=0.25 ).cuda()
        self.OCconv3 = OctaveConv(kernel_size=(3, 3), in_ch=128, out_ch=256, bias=False, alpha=0.125).cuda()
        self.OCconvl3 = LastOctaveConv(kernel_size=(3, 3), in_ch=256, out_ch=256, bias=False, stride=2, alpha=0.125).cuda()
        #self.OCconvf4 = FirstOctaveConv(kernel_size=(3, 3), in_ch=256, out_ch=512, bias=False, stride=2, alpha=0.25 ).cuda()
        self.OCconv4 = OctaveConv(kernel_size=(3, 3), in_ch=256, out_ch=512, bias=False, alpha=0.125).cuda()
        self.OCconvl4 = LastOctaveConv(kernel_size=(3, 3), in_ch=512, out_ch=512, bias=False, stride=2, alpha=0.125).cuda()
        #self.OCconvf5 = FirstOctaveConv(kernel_size=(3, 3), in_ch=512, out_ch=1024, bias=False, stride=2, alpha=0.25 ).cuda()
        self.OCconv5 = OctaveConv(kernel_size=(3, 3), in_ch=512, out_ch=1024, bias=False, alpha=0.125).cuda()
        self.OCconvl5 = LastOctaveConv(kernel_size=(3, 3), in_ch=1024, out_ch=1024, bias=False, stride=2, alpha=0.125).cuda()
        self.upsample = torch.nn.Upsample(scale_factor=2, mode='nearest')
